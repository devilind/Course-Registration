...
$sql2 = "Select * from tutorial_section where coursename = ".$_GET['id']."";
$result2 = mysqli_query($conn, $sql2);

$sql3 = "Select * from lab_section where coursename = ".$_GET['id']."";
$result3 = mysqli_query($conn, $sql3);

$sql="Select * from courses where Title = ".$_GET['id']."";
